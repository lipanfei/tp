...
CREATE TABLE `cms_admin` (
  ...
  `lastloginip` varchar(15) DEFAULT '0' COMMENT '登录的IP',
...
INSERT INTO `cms_admin` VALUES (1,'admin','d099d126030d3207ba102efa8e60630a','0',1497164921,'tracywxh0830@126.com','张三',1),(2,'singwa','a8ea3a23aa715c8772dd5b4a981ba6f4','0',1458139801,'','张三',-1),(3,'singwa','a8ea3a23aa715c8772dd5b4a981ba6f4','0',0,'','',-1),(4,'singwa3','79d4026540fdd95e4a0b627c77e6fa44','0',1458144621,'','singwa',1),(5,'cao yang1','9f24445952d45f7138a1b54eb74a2fdd','0',1497164396,'13319203205@163.com','曹阳',1);
...
CREATE TABLE `cms_menu` (
  ...
  `parentid` smallint(6) NOT NULL DEFAULT '0' COMMENT '多级导航的时候会用到',
  ...
  `type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '类型  0--前端栏目  1---后台菜单 ',
  PRIMARY KEY (`menu_id`),
  KEY `listorder` (`listorder`),
  KEY `parentid` (`parentid`),
  KEY `module` (`m`,`c`,`f`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_menu` VALUES (1,'菜单管理',0,'admin','menu','index','',26,1,1),(2,'文章管理',0,'admin','Content','index','',20,0,1),(3,'体育',0,'home','cat','index','',3,1,0),(5,'汽车',0,'home','cat','index','',0,1,0),(8,'科技',0,'home','cat','index','',1,1,0),(9,'推荐位管理',0,'admin','position','index','',19,1,1),(10,'推荐位内容管理',0,'admin','positioncontent','index','',18,1,1),(11,'基本管理',0,'admin','basic','index','',15,1,1),(12,'新闻',0,'home','cat','index','',2,1,0),(13,'用户管理',0,'admin','admin','index','',17,1,1),(19,'相册管理',0,'admin','piction','index','',14,1,1),(18,'轮播图管理',0,'admin','message','index','',13,0,0);
...
CREATE TABLE `cms_news` (
  `news_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '属于那个栏目',
  `title` varchar(80) NOT NULL DEFAULT '' COMMENT '标题',
  `small_title` varchar(30) NOT NULL DEFAULT '' COMMENT '文章副标题',
  `title_font_color` varchar(250) DEFAULT NULL COMMENT '标题颜色',
  `thumb` varchar(100) NOT NULL DEFAULT '' COMMENT '文章缩图',
  ...
  `listorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '文章排序',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  `copyfrom` varchar(250) DEFAULT '0' COMMENT '来源',
  `username` char(20) NOT NULL COMMENT '是那个用户添加的文章',
...
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='新闻文章主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_news` VALUES (17,3,'test','test','#5674ed','/p0x02k/upload/2016/03/13/56e5612d525c3.png','sss','sss','',1,-1,'0','admin',1455756856,0,0),(18,3,'你好ssss','你好','#ed568b','/p0x02k/upload/2016/03/13/56e56211c68e7.jpg','你好','你好sssss  ss','',2,-1,'3','admin',1455756999,0,0),(19,8,'1','11','#5674ed','/p0x02k/upload/2016/04/20/58f891c566b1d.jpg','1','1','',1,1,'0','admin',1456673467,0,1),(20,3,'事实上','11','#ed568b','/p0x02k/upload/2016/03/13/56e51fc82b13a.png','1','11','',2,-1,'0','admin',1456674909,0,0),(21,3,'习近平今日下午出席解放军代表团全体会议','习近平出席解放军代表团全体会议','#5674ed','/p0x02k/upload/2016/03/13/56e519a185c93.png','中共中央总书记 国家主席 中央军委主席 习近平','中共中央总书记','',2,1,'1','admin',1457854896,0,16),(22,12,'李克强让部长们当第一新闻发言人','李克强让部长们当第一新闻发言人','#ed568b','/p0x02k/upload/2016/03/13/56e51b6ac8ce2.jpg','李克强  新闻发言人','部长直接面对媒体回应关切，还能直接读到民情民生民意，而不是看别人的舆情汇报。','',1,1,'0','admin',1457855362,0,19),(23,3,'重庆美女球迷争芳斗艳','重庆美女球迷争芳斗艳','#5674ed','/p0x02k/upload/2016/03/13/56e51cbd34470.png','重庆美女 球迷 争芳斗艳','重庆美女球迷争芳斗艳','',4,1,'2','admin',1457855680,0,4),(24,3,'中超-汪嵩世界波制胜 富力客场1-0力擒泰达','中超-汪嵩世界波制胜 富力客场1-0力擒泰达','#5674ed','/p0x02k/upload/2016/03/13/56e51fc82b13a.png','中超 汪嵩世界波  富力客场 1-0力擒泰达','中超-汪嵩世界波制胜 富力客场1-0力擒泰达','',3,1,'0','admin',1457856460,0,15),(31,3,'古城西安','你怎么了','#5674ed','/p0x02k/upload/2017/05/17/1.jpg','西安','我们西安挺美的','',5,1,'0','admin',1494958386,0,2);
...
CREATE TABLE `cms_news_content` (
  ...
  `news_id` mediumint(8) unsigned NOT NULL COMMENT '文章主表id',
  `content` mediumtext NOT NULL COMMENT '文章内容',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '结束时间',
  PRIMARY KEY (`id`),
  KEY `news_id` (`news_id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='新闻文章副表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_position` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '结束时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='推荐位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_position` VALUES (1,'首页大图',-1,'展示首页大图的推荐位1',1455634352,0),(2,'首页大图',1,'展示首页大图的',1455634715,0),(3,'小图推荐',1,'小图推荐位',1456665873,0),(4,'首页后侧推荐位',-1,'',1457248469,0),(5,'右侧广告位',1,'右侧广告位123',1457873143,0);
...
CREATE TABLE `cms_position_content` (
  ...
  `position_id` int(5) unsigned NOT NULL COMMENT '推荐位id   关联主表id',
  `title` varchar(30) NOT NULL DEFAULT '' COMMENT '标题',
  `thumb` varchar(100) NOT NULL DEFAULT '' COMMENT '缩图',
  `url` varchar(100) DEFAULT NULL COMMENT 'url地址',
  `news_id` mediumint(8) unsigned NOT NULL COMMENT '文章id  因为它是管理文章的',
...
INSERT INTO `cms_position_content` VALUES (28,2,'习近平今日下午出席解放军代表团全体会议','/p0x02k/upload/2016/03/13/56e519a185c93.png','',21,0,1,1457854896,0),(27,2,'文章18测试sss','/p0x02k/upload/2016/03/07/56dcc0158f70e.JPG','',18,0,1,1457306930,0),(26,2,'ss','/p0x02k/upload/2017/05/31/592ed59bbed78.jpg','http://sina.com.cn',0,0,1,1457306890,0),(25,3,'test','/p0x02k/upload/2016/03/06/56dbdc0c483af.JPG',NULL,17,0,-1,1455756856,0),(23,2,'test','/p0x02k/upload/2016/03/06/56dbdc0c483af.JPG',NULL,17,1,-1,1455756856,0),(24,2,'你好ssss','/p0x02k/upload/2016/03/06/56dbdc015e662.JPG',NULL,18,2,-1,1455756999,0),(29,3,'李克强让部长们当第一新闻发言人','/p0x02k/upload/2016/03/13/56e51b6ac8ce2.jpg',NULL,22,12,1,1457855362,0),(30,3,'重庆美女球迷争芳斗艳','/p0x02k/upload/2016/03/13/56e51cbd34470.png',NULL,23,0,1,1457855680,0),(31,3,'中超-汪嵩世界波制胜 富力客场1-0力擒泰达','/p0x02k/upload/2016/03/13/56e51fc82b13a.png',NULL,24,0,1,1457856460,0),(32,5,'2015劳伦斯国际体坛精彩瞬间','/p0x02k/upload/2016/03/13/56e5612d525c3.png','http://sports.sina.com.cn/laureus/moment2015/',0,0,1,1457873220,0),(33,5,'singwa老师教您如何学PHP','/p0x02k/upload/2016/03/13/56e56211c68e7.jpg','http://t.imooc.com/space/teacher/id/255838',0,0,1,1457873435,0),(34,2,'ssw112','/p0x02k/upload/2017/05/31/592ecf1a79b07.jpg','http://sina.com.cn',0,0,1,1496239905,0),(36,2,'文章24测试','/p0x02k/upload/2016/03/13/56e51fc82b13a.png','',24,0,1,1496240363,0);
...
-- Dump completed on 2017-06-15 17:31:15

...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/p0x02k/Public/home/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/p0x02k/Public/home/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/p0x02k/Public/home/css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/p0x02k/Public/home/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="/p0x02k/Public/home/css/sing/common.css" />
    <link rel="stylesheet" href="/p0x02k/Public/home/css/party/bootstrap-switch.css" />
    <link rel="stylesheet" type="text/css" href="/p0x02k/Public/home/css/party/uploadify.css">

    <!-- jQuery -->
    <script src="/p0x02k/Public/home/js/jquery.js"></script>
      <script src="/p0x02k/Public/home/js/dialog/layer.js"></script>
    <script src="/p0x02k/Public/home/js/bootstrap.min.js"></script>
    <script src="/p0x02k/Public/home/js/dialog.js"></script>
    <script type="text/javascript" src="/p0x02k/Public/home/js/party/jquery.uploadify.js"></script>
</head>
...
<div id="wrapper">
  ...
  <?php  $navs = D('Menu')->getAdminMenus(); $username = getLoginUsername(); foreach($navs as $k=>$v) { if($v['c'] == 'admin' && $username != 'admin') { unset($navs[$k]); } } $index = 'index'; ?>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation"/>
  ...
  <div id="page-wrapper">
    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <form action="<?php echo U('/admin.php?');?>" method="get">
          <div class="col-md-3">
            <div class="input-group">
              <span class="input-group-addon">栏目</span>
              <select class="form-control" name="catid">
                  <option value='' >全部分类</option>
                  <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?><option value="<?php echo ($sitenav["menu_id"]); ?>"<?php if($sitenav["menu_id"] == $sitenav): ?>selected = "selected"<?php endif; ?> ><?php echo ($sitenav["name"]); ?></option><?php endforeach; endif; ?>
                </select>
            </div>
          </div>
...
<script>
  var SCOPE = {
    'edit_url' : "<?php echo U('/admin.php?c=content&a=edit');?>",
    'add_url' : "<?php echo U('/admin.php?c=content&a=add');?>",
    'set_status_url' : "<?php echo U('/admin.php?c=content&a=setStatus');?>",
    'sing_news_view_url' : "<?php echo U('/index.php?c=view');?>",
    'listorder_url' : "<?php echo U('/admin.php?c=content&a=listorder');?>",
    'push_url' : "<?php echo U('/admin.php?c=content&a=push');?>",
  }
</script>
<script src="/p0x02k/Public/home/js/admin/Common.js"></script>
